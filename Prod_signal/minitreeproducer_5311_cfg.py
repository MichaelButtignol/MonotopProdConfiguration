...
if not options.useData :
    ...
    process.source.fileNames = [
        'file:prod_S4_mchi200p0_2_RECO_n1000.root'
...
if options.useData :
    ...
    if options.globalTag is '':
        process.GlobalTag.globaltag = cms.string( 'START53_V29::All' ) #V20 should be used
        #process.GlobalTag.globaltag = cms.string( 'START53_V7G::All' ) #V20 should be used
    else:
        process.GlobalTag.globaltag = cms.string( options.globalTag )


#process.outputFile = cms.OutputModule(
#    "PoolOutputModule",
#    fileName = cms.untracked.string( 'store/user/mbuttign/AUG2014_LeptonicMonotop_8TeV_prod_S1_mres1000p0_mchi825p0_NTuple/NTuple_prod_S1_mres1000p0_mchi825p0_3.root')
#)
